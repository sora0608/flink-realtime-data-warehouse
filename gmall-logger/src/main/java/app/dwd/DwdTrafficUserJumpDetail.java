...
//        System.setProperty("HADOOP_USER_NAME", "atguigu");
        ...
        SingleOutputStreamOperator<JSONObject> withWatermarkStream = mappedStream.assignTimestampsAndWatermarks(
                WatermarkStrategy//广播，与key没有关系
                        .<JSONObject>forMonotonousTimestamps()
                        .withTimestampAssigner(//为什么不能放在KeyBy后
        ...
        // TODO 7. 定义 CEP 匹配规则
        Pattern<JSONObject, JSONObject> pattern = Pattern.<JSONObject>begin("first").where(//where条件过滤
        ...
        ).within(org.apache.flink.streaming.api.windowing.time.Time.seconds(10L));//窗口时间
